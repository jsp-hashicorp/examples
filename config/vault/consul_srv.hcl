...
client_addr = "0.0.0.0"
bind_addr = "0.0.0.0"
#bind_addr = "{{GetAllInterfaces | include \"network\" \"192.168.35.0/24\" | attr \"address\" }}"
...
#
#limits {
#	http_max_conns_per_client = 1044
#	rpc_max_conns_per_client = 1044
#}
server = true
ui_config = {
	 enabled = true
...
encrypt = "EySZ+pRUv3J0G4ET7Bl2KXe3ALW8wjFIrjlKp+/Ua30="
...
retry_join = ["NODES_IP","2nd_Nodes_IP"]
#retry_join = ["[::1]:8301"]
